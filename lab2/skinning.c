...
float weight[kMaxRow] = {0.10, 0.25, 0.4, 0.5, 0.6, 0.65, 0.70, 0.75, 0.85, 1.0};
...
void DeformCylinder()
{
	...
	//Bone Matrices
	mat4 mBen0 = T(g_bones[0].pos.x,g_bones[0].pos.y,g_bones[0].pos.z);
	mat4 mBen1 = T(g_bones[1].pos.x,g_bones[1].pos.y,g_bones[1].pos.z);
	mat4 invmBen0 = InvertMat4(mBen0);
	mat4 invmBen1 = InvertMat4(mBen1);
